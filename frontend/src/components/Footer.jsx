      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-2">
            <a href="#" className="hover:text-blue-500 text-gray-600 dark:text-gray-400"><Globe size={20} /></a>
            <a href="mailto:info@kazihaven.com" className="hover:text-red-500 text-gray-600 dark:text-gray-400"><Mail size={20} /></a>
            <a href="#" className="hover:text-blue-400 text-gray-600 dark:text-gray-400"><Twitter size={20} /></a>
